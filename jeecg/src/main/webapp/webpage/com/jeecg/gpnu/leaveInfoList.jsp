...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="leaveInfoList" checkbox="true" pagination="true" fitColumns="true" title="请假信息表" actionUrl="leaveInfoController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgDelOpt title="删除" url="leaveInfoController.do?doDel&id={id}"  urlclass="ace_button" operationCode="#delete"  urlfont="fa-trash-o"/>
   <t:dgToolBar title="录入" icon="icon-add"        operationCode="#add"  url="leaveInfoController.do?goAdd" funname="add"></t:dgToolBar>
   <t:dgToolBar title="查看申请流程" icon="icon-add"   funname="checkProcess" ></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit"       operationCode="#edit"  url="leaveInfoController.do?goUpdate" funname="update"></t:dgToolBar>
   <t:dgToolBar title="批量删除"  icon="icon-remove" operationCode="#doBatchDel"  url="leaveInfoController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
   ...
   <t:dgToolBar title="导出" icon="icon-putout"     operationCode="#excel"   funname="ExportXls"></t:dgToolBar>
   <t:dgToolBar title="模板下载" icon="icon-putout"  operationCode="#download"  funname="ExportXlsByT"></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>
...
function  checkProcess(){
		 $.ajax({
				type : "POST",
				url : "leaveActivitController.do?readProcessImg",
