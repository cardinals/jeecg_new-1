...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="leaveInfoList" checkbox="false" pagination="true" fitColumns="true" title="请假信息表" actionUrl="leaveInfoController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="业务关联"  field="processInstanceId"  queryMode="single"  width="120"></t:dgCol>
 ...
 <script src = "webpage/com/jeecg/myweb/leaveInfoList.js"></script>		
