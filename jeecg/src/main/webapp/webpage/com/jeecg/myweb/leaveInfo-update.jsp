 ...
 <body>
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="processInstanceId" name="processInstanceId" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${leaveInfoPage.processInstanceId}'/>
							<span class="Validform_checktip"></span>
							<label class="Validform_label" style="display: none;">业务关联</label>
						</td>
					</tr>
					<tr>
						<td align="right">
						...
						<td class="value">
						     	 <input id="userId" name="userId" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${leaveInfoPage.userId}'/>
							<span class="Validform_checktip"></span>
  ...
  <script src = "webpage/com/jeecg/myweb/leaveInfo.js"></script>		
